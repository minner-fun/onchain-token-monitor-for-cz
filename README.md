...
> 一个地址在发行 51 秒内就把 **70% 的总供应量锁进一个冷钱包、至今一枚未动**;这 700M 是免费铸的,币价 3 天被刷量拉了约 **260 倍**,现值 **~$2,850 万**——而项目方真实现金投入几乎为零(约 $1 万流动性、当天已卖币回本)。主池 CZ 库存只剩 0.9%,链上 3 天刷出约 **1.1 亿美元成交量**却建在仅 **86 万美元流动性**之上——量是「做」出来的,不是「买」出来的。近乎零成本的免费筹码 + 人为放量,70% 的铡刀悬在市场上方,下行风险全在买盘一侧。
