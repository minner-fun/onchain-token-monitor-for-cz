...
> 一个地址在发行 51 秒内就把 **70% 的总供应量锁进一个冷钱包、至今一枚未动**;主池 CZ 库存现在只剩 0.9%,外部流通约 29%(大量是机器人对敲的筹码);而链上 3 天刷出约 **1.1 亿美元成交量**,却建立在仅 **86 万美元流动性**之上——量是「做」出来的,不是「买」出来的。上方永远悬着一把 70% 的铡刀。
